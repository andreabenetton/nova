...
A Provider Path declares finite queue limits and whether it supports priority-prefix scheduling. These are inputs to P-Stratum common when constructing provider-independent service descriptions; they are not exported directly from P-Stratum.
