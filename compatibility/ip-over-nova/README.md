...
This direction is distinct from Nova over an IP-based P-RAP Binding:

- outer IP in a P-RAP Binding is an underlay;
- inner IP in IP-over-Nova is application payload.
