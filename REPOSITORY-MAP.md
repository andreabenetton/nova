...
| `contracts/` | normative | Versioned NIDL contracts, schemas, implementation declarations, locks, canonical generated JSON, conformance scenarios. |
| `protocols/` | normative drafts | Peer behavior inside P-Stratum, R-Stratum, and O-Stratum. |
| `integrations/` | normative drafts | P-LAP Adapters and P-RAP Bindings. |
...
| `tests/` | conformance evidence | Provider, consumer, protocol, interoperability, adversarial, and performance test organization. |
