...
`NOVA-IF-P-0AP-CONTROL 0.3.0` is a test-only Interface used to:
...
- configure Expansion cardinality and its profile, causing affected Provider Paths to update;
...
It is never a peer protocol and is invisible through the upper Interface.
