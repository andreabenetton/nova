...
A Provider Path is not an R-Stratum Edge. P-Stratum common aggregates it with any other Paths to the same Node identity.

The original P-Stratum paper is research input. This directory will become the normative P-LAP protocol specification.
